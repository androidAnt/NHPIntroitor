...
(function (Q, $) {
    ...
    Editor.prototype = {
        ...
        createToolbar: function () {
            ...
            toolbar.setAttribute('data-options', 'region:"north", height: 40','left: 0');
            return toolbar;
        },
        createToolbox: function (images) {
            ...
            if(!toolbox){
                ...
                toolbox.setAttribute('data-options', "region:'west', width:'18%', right:0, min-width:220, max-width:400");
            }
