...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      header.innerHTML = header.innerHTML + '<div class="sc-actions"><span class="sc-time">1</span></div>';
...
SimpleCalendar.prototype.languageData = {
  ...
  vocation: {
    data_2018: ['1-1', '2-15', '2-16', '2-17', '2-18', '2-19', '2-20', '2-21', '4-5', '4-6', '4-7', '4-28', '4-29', '4-30', '5-1', '6-16', '6-17', '6-18', '9-22', '9-23', '9-24',, '10-1', '10-2', '10-3', '10-4', '10-5', '10-6', '10-7']
  }
};
