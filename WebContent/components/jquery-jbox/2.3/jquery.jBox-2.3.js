...
(function (a) {
	a.jBox = function (b, c) {
		...
		j.push('<div id="jbox" class="jbox" style="position:absolute;height:auto;">');
		...
		j.push('<table class="jboxwid" border="0" cellpadding="0" cellspacing="0" style="width:370px;margin:0px;padding:0px;border:none;">');
		if (c.border > 0x0) {
			j.push('<tr>');
		...
		j.push('</div>');
		j.push('</div>');
		var k = '<iframe name="jbox-iframe-'+c.id+'" id="jbox-iframe" width="80%" height="100%" marginheight="0" marginwidth="0" frameborder="0" scrolling="' 
		...
		a.each(b, function (N, O) {
			...
			r.push('<div style="min-width:50px;width:' + (typeof c.width == 'number' ? c.width + 'px' : 'auto') + '; height:' + Q + ';">' + R + '<div id="jbox-content" class="jbox-content" style="height:' + Q + ';overflow:hidden;overflow-y:auto;overflow-x:hidden;">' + O.content + '</div></div>');
	...
	a.jBox.prompt = function (b, c, d, e) {
		...
		var h = [];
		h.push('html:');
		h.push('<div style="margin:10px;' + g + 'padding-left:' + (e.icon == 'none' ? 0x0 : 0x28) + 'px;text-align:left;padding-top:5px;">');
		h.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute; top:' + 55 + 'px;left:' + (0xa + e.border) + 'px; width:32px; height:32px;"></span>');
		h.push(e.content);
		h.push('</div>');
		e.content = h.join('');
		a.jBox(e.content, e)
	...
	a.jBox.messager = function (b, c, d, e) {
		...
		var i = [];
		i.push('html:');
		i.push('<div style="margin:10px;' + h + 'padding-left:' + (e.icon == 'none' ? 0x0 : 0x28) + 'px;text-align:left;padding-top:5px;">');
