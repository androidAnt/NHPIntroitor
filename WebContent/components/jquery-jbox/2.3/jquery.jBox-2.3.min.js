(function(a) {
    a.jBox = function(b, c) {
        ...
        var iframeA = '<iframe id="',
        iframeB = '" class="jbox-fade" src="about:blank" style="display:block;position:absolute;z-index:-1;" frameborder="no" width="0" height="0"></iframe>';
        if (c.showFade) {
        ...
        function(N, O) {
            ...
            r.push('<div style="min-width:50px; height:auto;">' + R + '<div id="jbox-content" class="jbox-content" style="height:' + Q + ';overflow:hidden;overflow-y:auto;">' + O.content + "</div></div>");
