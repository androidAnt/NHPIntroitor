...
(function ($) {
    $.jBox = function (content, options) {
        ...
        boxHtml.push('<table border="0" cellpadding="0" cellspacing="0" style="margin:0px;padding:0px;border:none;width:370px">');
        if (options.border > 0) {
            boxHtml.push('<tr>');
        ...
        boxHtml.push('<div class="jbox-container" style="width:360px; height:auto;">');
        ...
        var iframeHtml = '<iframe name="jbox-iframe" id="jbox-iframe" width="97%" height="100%" marginheight="0" marginwidth="0" frameborder="0" scrolling="no"></iframe>';
        ...
        $.each(content, function (stateName, stateOptions) {
            ...
            states.push('<div style="min-width:50px;width:300px;height:' + contentHeight + ';">' + loadingHtml + '<div id="jbox-content" class="jbox-content" style="height:' + contentHeight + ';overflow:hidden;overflow-y:auto;overflow-x:hidden;">' + stateOptions.content + '</div></div>');
