...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#DA251D"),
    ...
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#F6B800"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#DA251D", "#DA251D", "#DA251D"], 'array', ','),
