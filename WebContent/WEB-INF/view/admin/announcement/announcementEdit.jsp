...
<div class="row panel panel-default table-responsive ">
    ...
    <div class="panel-body">
        <div class="row">
            <form action="${root}/admin/announcement/doEdit" class="form-horizontal"  method="post" id="addContentForm" onsubmit="return doSubmit();" >
                <input type="hidden" name="backUrl" value="${backUrl}">
                 <input type="hidden" name="announcementId" id="announcementId" value="${ghAnnouncement.announcementId}">
                <div class="col-lg-12" style="padding-left: 0px;">
                    <div class="form-group">  
                     <label for="announcementTitle" class="col-md-2 control-label col-xs-4">标题<span style="color:red;">*</span></label>
                        <div class="col-md-4 col-xs-8">
                          <input type="text" class="form-control" required name="announcementTitle" id="announcementTitle" maxlength="50"  placeholder="标题" value="${ghAnnouncement.announcementTitle}">
                        </div>
                        ...
                        <input type="radio" name="isShowIndex" id="isShowIndex" value="0" <c:if test="${ghAnnouncement.isShowIndex=='0'||empty ghAnnouncement.isShowIndex}">checked</c:if>>是</label>
                        <label class="radio-inline" style="padding-top: 4px;">
                        <input type="radio" name="isShowIndex" value="1" <c:if test="${ghAnnouncement.isShowIndex=='1'}">checked</c:if>>否</label>
                        </div>
                    </div>
                    <div class="form-group">  
                        ...
                        <textarea name="summary"  id="summary" required class="form-control" maxlength="200" placeholder="最多输入200字" rows="2"
                                      >${ghAnnouncement.summary }</textarea>
                        </div>
                    </div>
            	<div class="form-group">  
