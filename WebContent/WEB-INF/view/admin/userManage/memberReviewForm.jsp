        ...
        <div class="row">
            <form action="${root}/system/user/doReview" method="post"  class="form-horizontal">
               <%--  <c:forEach items="${paramMap}" var="item" varStatus="status">
                ...
                <input type="hidden" name="backUrl" id="backUrl" value="${paramMap}">
                ...
                <div class="col-lg-12" style="padding-left: 0px;">
                    <div class="form-group">
                      ...
                      <label for="gender" class="col-xs-4 col-md-2 control-label">性别：</label>
                        <div class="col-md-4 col-xs-8">
                         <input disabled type="text" class="form-control" id="gender" name="gender" value="${user.gender}">
                        </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">  
                        ...
                        <textarea name="opinion"  id="opinion" class="form-control" rows="8" maxlength="200" required="required"
                                      ></textarea>
                        </div>
                    </div>
                </div>
...
<form action="${root}/system/user/memberReview" method="post" id="backForm">
    <c:forEach items="${paramMap}" var="item" varStatus="status">
        <input type="hidden" name="${item.key}" value="${item.value}"/>
    </c:forEach>
</form>
