                ...
                <tr>
                    ...
                    <td>
                        <c:if test="${list.loginName!=admin_loginName}">
                            ...
                            <a style="color: white;" href="${root}/admin/fileupload/downloadMemberFile?fileId=${list.memberFile}" >
                             <button title="下载" class="btn btn-xs btn-purple">
...
<form action="${root}/system/user/memberDetails" method="post" id="detailsForm">
