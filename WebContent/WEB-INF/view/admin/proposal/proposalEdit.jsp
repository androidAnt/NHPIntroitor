                ...
                <div class="col-lg-12" style="padding-left: 0px;">
                  ...
                  <input type="hidden" name="auditorType" id="auditorType" >
					...
					<div class="form-group">
						...
						<div class="form-group">
						<label for="proposal" class="col-md-2 control-label col-xs-4">审核<span
							style="color:red;">*</span></label>
							<div class=" col-lg-4 col-md-4 col-xs-8" style="top: 6px">
								<input type="radio" name="proposal" value="1" id="type1" checked onclick="show()">通过&nbsp;&nbsp;
                                <input type="radio" name="proposal" value="2" id="type2" onclick="hidd()">不通过 
							</div>
						</div>
						...
						<div class=" col-lg-10 col-md-4 col-xs-8">
							<textarea name="auditorContent" id="auditorContent" class="form-control"
								rows="3"   placeholder="请输入不通过原因，最多100字" maxlength="100">${tbProposal.auditorContent}</textarea>
						</div>
					</div>
