...
<div class="row">
    <div class="col-lg-6" style="padding: 0;margin-bottom: 10px;padding-right: 25px;">
        <div class="input-group">
            <input type="text" name="fileName" id="fileName" value="${tbDataDownload.fileName}" class="form-control" placeholder="资料名称,支持模糊查找"
                   maxlength="20">
...
<div class="row panel panel-default table-responsive">
    <div class="panel-heading">
        ...
        <shiro:hasPermission name="tb_data_add">
           <a class="btn btn-xs btn-add pull-right" title="添加资料下载" href="javascript:void(0);" id="toAdd">
                <i class="ace-icon fa fa-plus-square bigger-120"></i>添加资料下载
            </a>
        </shiro:hasPermission>
    </div>
        ...
        <table class="table table-bordered table-hover">
           ...
           <c:forEach items="${page.data}" var="list" varStatus="status">
                <tr>
                    ...
                    <td style="text-align: center;">${list.fileName}</td>
                   <%--  <td style="text-align: center;">${list.fileContent}</td> --%>
                    ...
                    <td style="text-align: center;">${ fn:substring(list.creatDate ,0,19)}</td>
 	                ...
 	                <shiro:hasPermission name="tb_data_edit">
                            <button class="btn btn-xs btn-info editData" title="修改" data-fileId="${list.fileId}">
                        ...
                        <shiro:hasPermission name="tb_data_info">
                            <button class="btn btn-xs btn-purple DataDetails " 
                                    title="查看详情" data-fileId="${list.fileId}">
 	                ...
 	                <shiro:hasPermission name="tb_data_del">
                            <button class="btn btn-xs btn-danger deleteData " data-toggle="modal" data-target="#delData"
                                    title="删除" data-fileId="${list.fileId}">
    ...
    <div class="modal-dialog" style="width:450px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">删除资料下载</h4>
            </div>
            <div class="modal-body">
                <form action="${root}/admin/data/delete" method="post" id="delForm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <form action="${root}/admin/data" method="post" class="form-horizontal" name="form1" id="form1">
                    ...
                    <input type="hidden" name="search_fileName" id="search_fileName" value="${tbDataDownload.fileName}">
...
<!--  查看详情 -->
 <form action="${root}/admin/data/getInfo" method="post" id="redirectForm">
...
<script>
	 ...
	 $('#fa-search').click(function () {
        $("#search_fileName").val($('#fileName').val());
        $("#pageNO").val(1);
	    $('#form1').submit();
    });
//     重置
      $('#search_ret').click(function () {
      	$("#search_fileName").find("option").eq("").prop("selected",true)
    ...
    $("#toAdd").click(function () {
        $("#form1").attr('action',root+"/admin/data/toadd");
        $('#form1').submit();
    });
    //准备删除信息
    $('.deleteData').click(function () {
        $('#fileId').val($(this).attr('data-fileId'));
    });
    //执行删除操作
    ...
    $('.DataDetails').click(function () {
	    $("#editFileId").val($(this).attr('data-fileId'));
	    $("#disabled").val(false);
	    $('#redirectForm').submit();
	});
	//修改
