...
<div class="row panel panel-default table-responsive">
    <div class="panel-heading"><span class="fa fa-edit" aria-hidden="true"></span><b>修改广告</b></div>
    <div class="panel-body">
        <div class="row">
            <form action="${root}/admin/advert/doEdit" class="form-horizontal" method="post" id="editAdvertForm"
                  onsubmit="return doSubmit();">
                <input type="hidden" name="picUrl" id="picUrl" value="${advert.picUrl}">
                <input type="hidden" name="backUrl" id="backUrl" value="${backUrl}">
                <input type="hidden" name="aId" id="aId" value="${advert.aId}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-xs-8">
                            <select name="apId" id="apId" class="form-control" required>
                                ...
                                <c:forEach items="${positionList}" var="positionList">
                                    <option value="${positionList.apId}_${positionList.width}_${positionList.height}"
                                            <c:if test="${advert.apId==positionList.apId}">selected</c:if>>${positionList.title}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-8">
                            <input type="url" class="form-control" name="link" id="link" maxlength="120"
                                   placeholder="广告链接" required value="${advert.link}">
                        </div>--%>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group <c:if test="${empty advert.picUrl}">hide</c:if>" id="picDiv">
                        ...
                        <div class="col-md-10 col-xs-8">
                            <div id="picUrl_img" style="border: 1px solid #ddd;border-radius: 4px;vertical-align: middle;text-align: center;">
                                <img src="${root}${advert.picUrl}">
                            </div>
                            <div style="text-align: center;margin-top: 10px;" id="croppicBtnDiv">
                                <button class="btn btn-xs btn-success" type="button" id="croppicBtn"><i
                                        class="ace-icon fa fa-upload bigger-120"></i>修改图片
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" style="width:810px;" >
        <div class="modal-content"  >
            <div class="modal-header">
                ...
                <h4 class="modal-title">选择单个商家</h4>
            </div>
...
<form action="${root}/admin/advert" method="post" id="backForm">
