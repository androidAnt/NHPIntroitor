...
<%-- 				<c:forEach items="${page.data}" var="announcement" > --%>
<!-- 					 <li> -->
<%-- 					    <a  href="${root}/app/module/announcementInfo?id=${announcement.announcementId}"> --%>
<!-- 					        <div class="txt"> -->
<!-- 					            <span class="title"> -->
...
<!-- 					            </p> -->
<%-- 								<span class="time">${announcement.time}【MORE】</span> --%>
<!-- 					        </div> -->
<!-- 					    </a> -->
<!-- 					</li> -->
<%-- 					</c:forEach> --%>
...
<%-- 				</c:forEach> --%>
		...
		var isShow = '${isShow}';
			...
			window.location.href="${root}/app/module/announcementList?isShow="+isShow;
// 				//加载轮播数据..
// 				//...
// 				//加载列表数据
...
// 				});
			...
			function setListData(data, isAppend) {
				...
				for (var i = 0; i < data.length; i++) {
					var newObj=data[i];
					var str = '<a href="${root}/app/module/announcementInfo?id='+newObj.announcementId+'&isShow='+isShow+'">'
					str+='<div class="txt">'
					str+='<span class="title">'+newObj.announcementTitle+'</span>';
					str+='<p>'+newObj.summary+'</p>';
					str+='<span class="time">'+newObj.time+'【MORE】</span>'
					str+=' </div> </a>'
...
// 	                		newArr.push(newObj);
	                	      ...
	                	      var data = new FormData();
 		                      ...
 		                      data.append("pageSize", pageSize);
								//此处模拟上拉加载返回的数据
								$.ajax({
									url : "${root}/app/module/announcementListAjax",
									type : "post",
									data : data,
									async : false,
									dataType : "JSON",
