...
<div class="box">
		...
		<div class="article-list-content-info">
			...
			<div class="article-info-content">
				<p class="title">${download.fileName}</p>
				<p class="time">时间:${download.creatDate}</p>
				<p class="content">${download.fileContent}</p>
				<c:if test="${not empty download.fileList}">
				<p>附件列表:
                <c:forEach items="${download.fileList}" var="con">
