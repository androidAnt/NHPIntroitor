...
<div class="box">
		...
		<div class="article-list-content-info">
			...
			<div class="article-list-content-info-title">
				...
				<span class="p1">政策法规</span>
			</div>
			
			<ul class="mailBoxList">
			<c:forEach items="${page.data}"
								var="content">
							<li><a href="${root}/home/module/tbPoliciesInfo?id=${content.policiesId}&menuId=${GhMenuManage.menuId}">
									<div class="txt">
										<span class="title"> ${content.policiesName}</span> <span
...
<form action="${root}/home/module/tbPolicies" method="post" class="form-horizontal" name="form1" id="form1">
