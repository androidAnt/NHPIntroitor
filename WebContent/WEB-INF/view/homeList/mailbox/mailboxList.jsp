...
<div class="box">
		...
		<div class="article-list-content-info" style="width: 100%;">
			...
			<c:forEach items="${page.data}"
								var="content">
				<li>
				    <a href="${root}/home/module/TbMailboxPageInfo?id=${content.mailboxId}">
				        <div class="txt">
				            <span class="title">
				                ${content.title}
				            </span>
...
<form action="${root}/home/module/listTbMailboxPage" method="post" class="form-horizontal" name="form1" id="form1">
