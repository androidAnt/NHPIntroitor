...
<div class="panel-heading ztree-class">
		...
		<b>组织机构结构</b>
		<ul id="tree-rec" class="ztree" ></ul>
	</div>

<!-- <div class="row panel panel-default table-responsive "> -->
   <div class="orgtable-class">
   	<iframe id="orgContent" src="${root}/system/org/orgList?id=&queryVal=" width="100%" height=500px scrolling="no" frameborder="0"></iframe>
<!--    </div> -->
		...
		callback: {
			...
			onClick:function(event, treeId, treeNode){
					...
					var orgName = $("#queryName").val()
 					$('#orgContent').attr("src","${root}/system/org/orgList?pId="+id+"&orgName="+orgName);
					}
		}
	};
	var zNodes;
	$(document).ready(function(){
		$.ajax({
	  	      ...
	  	      zNodes = res
	  	       ...
	  	       var treeObj = $.fn.zTree.getZTreeObj("tree-rec");  //得到该tree
           		 var node = treeObj.getNodeByTId("tree-rec_1");  //选中第一个节点
